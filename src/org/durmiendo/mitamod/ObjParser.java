...
public class ObjParser {
    ...
    public static Obj.Mtl cur = Obj.Mtl.zerom;
    ...
    public static Obj loadObj(String s) {
        ...
        Obj o =  loadObj(
                MitaMod.internalFileTree.child("models/" + s +".obj").readString(),
                MitaMod.internalFileTree.child("models/" + s +".mtl").readString()
        );
        loaded.put(s, o);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                switch (parts[0]) {
                    ...
                    case "illum":
                        ...
                        break;
                    case "map_Kd":
                        Texture t = new Texture(MitaMod.internalFileTree.child( "models/" + parts[1]));
